...
os.makedirs("./sort_trime_allx6/trime﹤allin1﹥/opencc/", exist_ok=True)


#複製檔案(洋蔥同文注音純注音版)
shutil.copyfile("./trimefiles/essay-zh-hant-mc.txt", "./sort_trime_allx6/trime﹤allin1﹥/essay-zh-hant-mc.txt")
shutil.copyfile("./trimefiles/bpmfmobile.extended.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/bpmfmobile.extended.dict.yaml")
shutil.copyfile("./trimefiles/bpmfmobile.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/bpmfmobile.schema.yaml")
shutil.copyfile("./trimefiles/element_bpmf.yaml", "./sort_trime_allx6/trime﹤allin1﹥/element_bpmf.yaml")
shutil.copyfile("./trimefiles/mobile_bpmf.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/mobile_bpmf.dict.yaml")
shutil.copyfile("./trimefiles/mobile_bpmf.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/mobile_bpmf.schema.yaml")
shutil.copyfile("./trimefiles/phrases.cht.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/phrases.cht.dict.yaml")
shutil.copyfile("./trimefiles/phrases.chtp.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/phrases.chtp.dict.yaml")
shutil.copyfile("./trimefiles/punct_bpmf.yaml", "./sort_trime_allx6/trime﹤allin1﹥/punct_bpmf.yaml")
shutil.copyfile("./trimefiles/rime.lua", "./sort_trime_allx6/trime﹤allin1﹥/rime.lua")
shutil.copyfile("./trimefiles/sy_bpmf.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/sy_bpmf.dict.yaml")
shutil.copyfile("./trimefiles/sy_bpmf.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/sy_bpmf.schema.yaml")
shutil.copyfile("./trimefiles/terra_pinyin_onion_add.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/terra_pinyin_onion_add.dict.yaml")
shutil.copyfile("./trimefiles/terra_pinyin_onion.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/terra_pinyin_onion.dict.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥注音331k_H.trime.yaml", "./sort_trime_allx6/trime﹤allin1﹥/洋蔥注音331k_H.trime.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥注音331k_L.trime.yaml", "./sort_trime_allx6/trime﹤allin1﹥/洋蔥注音331k_L.trime.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥注音331k_M.trime.yaml", "./sort_trime_allx6/trime﹤allin1﹥/洋蔥注音331k_M.trime.yaml")
shutil.copyfile("./trimefiles/opencc/bpm_moedict_big5e_hkscs_jis.json", "./sort_trime_allx6/trime﹤allin1﹥/opencc/bpm_moedict_big5e_hkscs_jis.json")
shutil.copyfile("./trimefiles/opencc/bpm_moedict_big5e_hkscs_jis.txt", "./sort_trime_allx6/trime﹤allin1﹥/opencc/bpm_moedict_big5e_hkscs_jis.txt")
shutil.copyfile("./trimefiles/opencc/emoji_t_m.json", "./sort_trime_allx6/trime﹤allin1﹥/opencc/emoji_t_m.json")
shutil.copyfile("./trimefiles/opencc/emoji_t_m.txt", "./sort_trime_allx6/trime﹤allin1﹥/opencc/emoji_t_m.txt")
shutil.copyfile("./trimefiles/opencc/punct_mark_t.json", "./sort_trime_allx6/trime﹤allin1﹥/opencc/punct_mark_t.json")
shutil.copyfile("./trimefiles/opencc/punct_mark_t.txt", "./sort_trime_allx6/trime﹤allin1﹥/opencc/punct_mark_t.txt")
shutil.copyfile("./trimefiles/opencc/back_mark_t.json", "./sort_trime_allx6/trime﹤allin1﹥/opencc/back_mark_t.json")
shutil.copyfile("./trimefiles/opencc/back_mark_series_t.json", "./sort_trime_allx6/trime﹤allin1﹥/opencc/back_mark_series_t.json")
shutil.copyfile("./trimefiles/opencc/back_mark_script_t.txt", "./sort_trime_allx6/trime﹤allin1﹥/opencc/back_mark_script_t.txt")
...
shutil.copyfile("./trimefiles/bpmfmobileplus.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/bpmfmobileplus.schema.yaml")
shutil.copyfile("./trimefiles/hangeul_m.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul_m.dict.yaml")
shutil.copyfile("./trimefiles/hangeul_hanja.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul_hanja.dict.yaml")
shutil.copyfile("./trimefiles/hangeul_m.extended.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul_m.extended.dict.yaml")
shutil.copyfile("./trimefiles/hangeul.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul.schema.yaml")
shutil.copyfile("./trimefiles/hangeul_hnc_m.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul_hnc_m.schema.yaml")
shutil.copyfile("./trimefiles/hangeul_hnc_m.extended.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul_hnc_m.extended.dict.yaml")
shutil.copyfile("./trimefiles/hangeul_hnc_m.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul_hnc_m.dict.yaml")
shutil.copyfile("./trimefiles/hangeul_hnc_hanja.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/hangeul_hnc_hanja.dict.yaml")
shutil.copyfile("./trimefiles/jpnin1.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/jpnin1.dict.yaml")
shutil.copyfile("./trimefiles/jpnin1_hw.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/jpnin1_hw.dict.yaml")
shutil.copyfile("./trimefiles/jpnin1.extended.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/jpnin1.extended.dict.yaml")
shutil.copyfile("./trimefiles/jpnin1.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/jpnin1.schema.yaml")
...
shutil.copyfile("./trimefiles/punt_ocm.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/punt_ocm.schema.yaml")
shutil.copyfile("./trimefiles/phrases.ocmtc_essay_mc.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/phrases.ocmtc_essay_mc.dict.yaml")
shutil.copyfile("./trimefiles/ocm_tc_mc_m.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/ocm_tc_mc_m.dict.yaml")
shutil.copyfile("./trimefiles/uniabcdword.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/uniabcdword.dict.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥蝦米331k_H.trime.yaml", "./sort_trime_allx6/trime﹤allin1﹥/洋蔥蝦米331k_H.trime.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥蝦米331k_L.trime.yaml", "./sort_trime_allx6/trime﹤allin1﹥/洋蔥蝦米331k_L.trime.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥蝦米331k_M.trime.yaml", "./sort_trime_allx6/trime﹤allin1﹥/洋蔥蝦米331k_M.trime.yaml")
shutil.copyfile("./trimefiles/sy_ocm.dict.yaml", "./sort_trime_allx6/trime﹤allin1﹥/sy_ocm.dict.yaml")
shutil.copyfile("./trimefiles/sy_ocm.schema.yaml", "./sort_trime_allx6/trime﹤allin1﹥/sy_ocm.schema.yaml")
shutil.copyfile("./trimefiles/opencc/ocm_moedict_big5e_hkscs_jis.json", "./sort_trime_allx6/trime﹤allin1﹥/opencc/ocm_moedict_big5e_hkscs_jis.json")
...
#實體(藍牙)鍵盤專用
shutil.copytree("./trimefiles/實體(藍牙)鍵盤專用/", "./sort_trime_allx6/實體(藍牙)鍵盤專用/")


#各版主程式
shutil.copytree("./trimefiles/各版主程式/", "./sort_trime_allx6/各版主程式/")
...
#初始化方案
shutil.copytree("./trimefiles/初始化方案/", "./sort_trime_allx6/初始化方案/")


#OpenCC_ocd_64位元
shutil.copytree("./trimefiles/OpenCC_ocd_64位元/", "./sort_trime_allx6/OpenCC_ocd_64位元/")


#font字型
shutil.copytree("./trimefiles/fonts/", "./sort_trime_allx6/fonts/")


#名稱增加日期
localtime=time.strftime("%Y%m%d", time.localtime())

os.rename("./sort_trime_allx6/trime﹤allin1﹥/", "./sort_trime_allx6/trime﹤allin1﹥_"+localtime)

os.rename("./sort_trime_allx6/", "./洋蔥手機同文方案﹤allin1﹥_"+localtime)
