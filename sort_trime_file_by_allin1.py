...
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥蝦米331k_H.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥蝦米331k_H.trime.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥蝦米331k_L.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥蝦米331k_L.trime.yaml")
shutil.copyfile("./trimefiles/3.3.1鍵盤檔/洋蔥蝦米331k_M.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥蝦米331k_M.trime.yaml")
