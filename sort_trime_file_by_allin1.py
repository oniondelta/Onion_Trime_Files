...
#名稱(取出來較好變換)
sort_trime="sort_trime_allx6"
trime_files="trime＜allin1＞"
the_name="洋蔥手機同文方案＜allin1＞"
...
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥注音3_3_11k_H.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥注音3_3_11k_H.trime.yaml")
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥注音3_3_11k_L.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥注音3_3_11k_L.trime.yaml")
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥注音3_3_11k_M.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥注音3_3_11k_M.trime.yaml")
...
shutil.copyfile("./trimefiles/predict-kenspc-zht.db", "./"+sort_trime+"/"+trime_files+"/predict-kenspc-zht.db")
...
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥雙拼注音3_3_11k_H.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥雙拼注音3_3_11k_H.trime.yaml")
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥雙拼注音3_3_11k_L.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥雙拼注音3_3_11k_L.trime.yaml")
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥雙拼注音3_3_11k_M.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥雙拼注音3_3_11k_M.trime.yaml")
...
shutil.copyfile("./trimefiles/omp_kr.extended.dict.yaml", "./"+sort_trime+"/"+trime_files+"/omp_kr.extended.dict.yaml")
shutil.copyfile("./trimefiles/omp_kr.schema.yaml", "./"+sort_trime+"/"+trime_files+"/omp_kr.schema.yaml")
...
shutil.copyfile("./trimefiles/punct_ovff.yaml", "./"+sort_trime+"/"+trime_files+"/punct_ovff.yaml")
shutil.copyfile("./trimefiles/element_ovff.yaml", "./"+sort_trime+"/"+trime_files+"/element_ovff.yaml")
shutil.copyfile("./trimefiles/punt_ocm.dict.yaml", "./"+sort_trime+"/"+trime_files+"/punt_ocm.dict.yaml")
shutil.copyfile("./trimefiles/punt_ocm.schema.yaml", "./"+sort_trime+"/"+trime_files+"/punt_ocm.schema.yaml")
shutil.copyfile("./trimefiles/phrases.ocmtc_essay_mc.dict.yaml", "./"+sort_trime+"/"+trime_files+"/phrases.ocmtc_essay_mc.dict.yaml")
shutil.copyfile("./trimefiles/ocm_tc_mc_m.dict.yaml", "./"+sort_trime+"/"+trime_files+"/ocm_tc_mc_m.dict.yaml")
shutil.copyfile("./trimefiles/uniabcdword.dict.yaml", "./"+sort_trime+"/"+trime_files+"/uniabcdword.dict.yaml")
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥蝦米3_3_11k_H.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥蝦米3_3_11k_H.trime.yaml")
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥蝦米3_3_11k_L.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥蝦米3_3_11k_L.trime.yaml")
shutil.copyfile("./trimefiles/3.3.11鍵盤檔/洋蔥蝦米3_3_11k_M.trime.yaml", "./"+sort_trime+"/"+trime_files+"/洋蔥蝦米3_3_11k_M.trime.yaml")
shutil.copyfile("./trimefiles/sy_ocm.dict.yaml", "./"+sort_trime+"/"+trime_files+"/sy_ocm.dict.yaml")
shutil.copyfile("./trimefiles/sy_ocm.schema.yaml", "./"+sort_trime+"/"+trime_files+"/sy_ocm.schema.yaml")
shutil.copyfile("./trimefiles/opencc/ocm_moedict_big5e_hkscs_jis.json", "./"+sort_trime+"/"+trime_files+"/opencc/ocm_moedict_big5e_hkscs_jis.json")
shutil.copyfile("./trimefiles/opencc/ocm_moedict_big5e_hkscs_jis.txt", "./"+sort_trime+"/"+trime_files+"/opencc/ocm_moedict_big5e_hkscs_jis.txt")


#複製檔案(洋蔥手機蝦-mixin)
shutil.copyfile("./trimefiles/ovffmobile.extended.dict.yaml", "./"+sort_trime+"/"+trime_files+"/ovffmobile.extended.dict.yaml")
shutil.copyfile("./trimefiles/ovffmobile.schema.yaml", "./"+sort_trime+"/"+trime_files+"/ovffmobile.schema.yaml")
...
#適用3.3.11鍵盤檔
shutil.copytree("./trimefiles/3.3.11鍵盤檔/", "./"+sort_trime+"/3.3.11鍵盤檔/")
