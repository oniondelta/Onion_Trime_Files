...
shutil.copyfile("./trimefiles/tcword.dict.yaml", "./sort_trime/洋蔥手機蝦/ocm_mixin/tcword.dict.yaml")
...
shutil.copyfile("./trimefiles/tcword.dict.yaml", "./sort_trime/洋蔥手機蝦/ocm_plus/tcword.dict.yaml")
