...
####  ※ 預設鍵盤檔只適用[ trime 3.2.6 版](https://github.com/osfans/trime/releases/tag/v3.2.6) [ trime 3.2.7 版](https://github.com/osfans/trime/releases/tag/v3.2.7)
####  ※ 內附舊版[ trime 3.2.1 版](https://github.com/osfans/trime/releases/tag/v3.2.1) 鍵盤檔
####  ※ 3.2.6 和 3.2.7 版方案部署比舊版慢很多，需很有耐心，全部方案一次性加入部署需要50分鐘XD
